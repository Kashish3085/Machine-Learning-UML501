...
def cat(rating):
    if rating >= 4.5:
        ...
        return "Average"
df["Performance"] = df["Rating"].apply(cat)
print("Updated dataset with Performance categorization:\n",df)
#H
...
print("Employees with >5 years experience:\n",exp)
#J2
...
print("Modified dataset saved to 'employees.csv'.")